...
class Evaluator(object):
    ...
    def calculate_per_class_metrics(self):
        ...
        FNs = np.sum(self.confusion_matrix, axis=1) - TPs #[1:] - TPs
        FPs = np.sum(self.confusion_matrix, axis=0) - TPs #[1:] - TPs
        return TPs, FNs, FPs
    
    def Damage_Precision_Recall(self):
    ...
    def Damage_F1_score(self):
        precisions, recalls = self.Damage_Precision_Recall()
